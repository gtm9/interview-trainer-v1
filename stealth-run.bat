...
mkdir "%APPDATA%\interview-trainer-v1\temp" 2>nul
mkdir "%APPDATA%\interview-trainer-v1\cache" 2>nul
mkdir "%APPDATA%\interview-trainer-v1\screenshots" 2>nul
mkdir "%APPDATA%\interview-trainer-v1\extra_screenshots" 2>nul
