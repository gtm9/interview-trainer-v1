#!/bin/bash
echo "=== Interview Trainer - Invisible Edition (No Paywall) ==="
echo
...
mkdir -p ~/Library/Application\ Support/interview-trainer-v1/temp
mkdir -p ~/Library/Application\ Support/interview-trainer-v1/cache
mkdir -p ~/Library/Application\ Support/interview-trainer-v1/screenshots
mkdir -p ~/Library/Application\ Support/interview-trainer-v1/extra_screenshots
