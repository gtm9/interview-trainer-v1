...
// Register the interview-trainer protocol
if (process.platform === "darwin") {
  app.setAsDefaultProtocolClient("interview-trainer")
} else {
  app.setAsDefaultProtocolClient("interview-trainer", process.execPath, [
...
async function initializeApp() {
  try {
    ...
    const appDataPath = path.join(app.getPath('appData'), 'interview-trainer-v1')
